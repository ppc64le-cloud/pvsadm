...
import (
	...
	"github.com/ppc64le-cloud/pvsadm/pkg/client/sshkeys"
...
func NewPVMClient(c *Client, instanceID, instanceName, ep string) (*PVMClient, error) {
	...
	pvmclient.SshKeysClient = sshkeys.NewClient(pvmclient.PISession, instanceID)
