...
{{end}}
{{if eq .Dist "centos"}}
yum-config-manager --add-repo=https://public.dhe.ibm.com/software/server/POWER/Linux/yum/IBM/CentOS/ppc64le/
rpm --import https://public.dhe.ibm.com/software/server/POWER/Linux/yum/IBM/CentOS/ppc64le/repodata/repomd.xml.key
{{end}}
