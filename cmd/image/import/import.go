...
`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		start := time.Now()
		var message string
		err = utils.PollUntil(time.Tick(2*time.Minute), time.After(opt.WatchTimeout), func() (string, bool, error) {
		...
		return utils.PollUntil(time.Tick(10*time.Second), time.After(opt.WatchTimeout), func() (string, bool, error) {
